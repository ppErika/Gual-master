...
class PartyUserDeleteActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?){
        super.onCreate(savedInstanceState)

        val uid = intent.getLongExtra("uid",0)
        val data = MyPartyUserDeleteBtn(uid)
        ...
        retrofitClient.service?.postRequest(data)?.enqueue(object : Callback<PostResult> {
            ...
            override fun onFailure(call: Call<PostResult>, t: Throwable) {
                Log.e("partyuserdeleteBtn1", t.toString())
                Log.d("partyuserdeleteBtn1", "fail")
            }
            ...
            override fun onResponse(call: Call<PostResult>, response: Response<PostResult>) {
                ...
                if (response.isSuccessful()) {
                    Log.d("partyuserdeleteBtn2", response.body().toString())
                    Log.d("partyuserdeleteBtn2", response.toString())
                    ...
                    val intent = Intent( getApplicationContext(),EditPartyActivity::class.java)
